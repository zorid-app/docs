---
title: "Zorid: open-source Markdown workspace with typed fields"
description: "Zorid is an open-source, cross-platform Markdown workspace with typed frontmatter fields, embedded database views, and a lazy-loaded plugin system."
---
