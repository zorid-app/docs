---
title: "Fields"
description: "The fields core plugin renders typed frontmatter editors for notes and resolves .ztype type definitions so field values stay consistent across the vault."
icon: "table-list"
---
