---
title: "Search"
description: "The search core plugin runs full-text and field-aware queries across your vault using the SQLite-backed index, with results scoped by tags and frontmatter."
