...
description: "Why Zorid splits packages by vertical concern and gates each one behind typed Platform APIs to keep plugins, kernel, and storage cleanly decoupled."
icon: "file-contract"
---
