...
description: "How Zorid handles typed frontmatter fields, .ztype schema definitions, and the Notion-like preservation rules that keep unknown fields safe on disk."
icon: "table-list"
---
