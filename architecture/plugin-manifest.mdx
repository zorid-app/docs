...
description: "Reference for the Zorid plugin manifest file, including identifiers, contributed commands and views, and the lazy activation triggers that load plugins."
icon: "file-code"
---
