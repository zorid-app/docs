---
title: "Quickstart: clone, install, and run the Zorid desktop app"
description: "Clone the Zorid monorepo, install dependencies with pnpm, launch the Electron desktop app, and create your first typed note with an embedded view."
---
